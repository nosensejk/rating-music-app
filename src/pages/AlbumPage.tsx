    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      <div className="mx-auto max-w-6xl p-8">
        ...
        <div className="mt-8">
          ...
          <p className="text-zinc-400 mb-3">Average: {avg.toFixed(1)} / 100</p>
          <div className="flex gap-3 items-center">
            <input type="number" min={0} max={100} value={userRating} onChange={(e) => setUserRating(Number(e.target.value))} className="w-24 rounded bg-zinc-900 border border-zinc-700 px-3 py-2 text-white" />
            <button onClick={async () => {
               ...
               setAvg(newAvg);
               setUserRating(0);
            }} className="px-4 py-2 bg-blue-600 hover:bg-blue-500 rounded">Submit</button>
          </div>
        </div>
      </div>
    </div>
